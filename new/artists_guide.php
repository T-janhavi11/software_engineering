...
<style type="text/css">
   ...
   .head-artists {
        ...
        .hr{
          ...
          background: url(pictures/bg5.jpg) no-repeat fixed;
...
<body class="guide-background">
            ...
            <h3 class="word1">Selling your art has never been so easy!</h3><br>
           <p class="word2">
                        1. Register and upload your artwork on <a style="color:#f2f2f2;" href="home.php">ART+</a><br>
                        2. Ship the artwork to the buyer.<br>
                        3. Receive 80% of the selling price.<br>
            </p>

            <h3 class="word1">How do I apply to exhibit my artwork at ART + ?</h3><br>
                <p class="word2">Please click the "Sign Up" link at the top right of this page.</p>

            <h3 class="word1">Can artists living outside of the India apply?</h3><br>
                <p class="word2">No. Our application is only open to artists from India.</p>

            <h3 class="word1">What does the application entail?</h3><br>
            ...
            <h3 class="word1">Is there an application fee?</h3><br>
                 <p class="word2">No. Registration is free.</p>

            <h3 class="word1">What kind of artwork do you show?</h3><br>
                <p class="word2">We exhibit art in every genre, style, size, and media.</p>

            <h3 class="word1">How will you market my art?</h3><br>
            ...
            <h3 class="word1">What is your commission structure?</h3><br>
                <p class="word2"> ARTPLUS Gallery will pay you 80% of the selling price.  Pay for shipping and get your profit!<br><br>
            ...
            You keep 80% of this amount: Php. 60,000. This is the amount you will receive from us.<br><br>
            ...
            <h3 class="word1">Who covers the costs of packaging and shipping the artwork to the Buyer’s address?</h3><br>
                <p class="word2">You (the artist) cover the cost of packaging and shipping the artwork to the Buyer.</p>

            <h3 class="word1" >Where is ARTPLUS based?</h3><br>
                <p class="word2">Our main office is located in BUCS, Legazpi city, although we are primarily a virtual gallery.</p>

            <h3 class="word1">If I exhibit my work at ART +, may I seek other gallery representation?</h3><br>
                <p class="word2">Yes.</p>

            <h3 class="word1">How do I know when my artwork is sold? What do I do once it is sold?</h3><br>
                <p class="word2">Once your art is sold, you will receive an email notifying you of the sale.</p>

            <h3 class="word1">When and how do I get paid for sold artwork?</h3><br>
                <p class="word2">We pay by Cash on Delivery payment method that transfers 7 day after artwork is delivered to the client.</p>

            <h3 class="word1">Who owns the rights to my artwork once it is sold?</h3><br>
                <p class="word2">You retain the rights to your art after it is sold.</p>

            <h3 class="word1">Can clients living outside of the United States purchase my art on ART + ?</h3><br>
                <p class="word2">No! We don't allow international customers.</p>

            <h3 class="word1">How do I submit more art if I am already exhibiting my work at ART + ?</h3><br>
