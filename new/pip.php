      ...
      <div class="whiteborder">
        <h3> Dear '.$courier_name.',</h3>
         ...
         <p>
            ...
            Note:<br><br>
            In the event that the information you provided is incomplete, a validation may be sent through phone call or SMS as part of Artplus Artworks\'s order verification requirement.<br> Please be kind enough to respond if you receive either a call from (02)795 8900 or an SMS from sender of our Artworks. If you do not receive any communication from us <br>your order will automatically be processed.<br><br>
